...
namespace Langben.App.Controllers
{
    ...
    /// 员工银行
    /// </summary>
    public class EmployeeBankApiController : BaseApiController
    {
        /// <summary>
        /// 异步加载数据
        /// </summary>
        ...
        {
            int total = 0;
            List<EmployeeBank> queryData = m_BLL.GetByParam(getParam.id, getParam.page, getParam.rows, getParam.order, getParam.sort, getParam.search, ref total);
        ...
        IBLL.IEmployeeBankBLL m_BLL;

        ValidationErrors validationErrors = new ValidationErrors();

        public EmployeeBankApiController()
            : this(new EmployeeBankBLL()) { }

        public EmployeeBankApiController(EmployeeBankBLL bll)
        {
            m_BLL = bll;
        }
