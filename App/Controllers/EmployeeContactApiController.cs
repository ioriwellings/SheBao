...
namespace Langben.App.Controllers
{
    ...
    /// 员工联系方式
    /// </summary>
    public class EmployeeContactApiController : BaseApiController
    {
        /// <summary>
        /// 异步加载数据
        /// </summary>
        ...
        {
            int total = 0;
            List<EmployeeContact> queryData = m_BLL.GetByParam(getParam.id, getParam.page, getParam.rows, getParam.order, getParam.sort, getParam.search, ref total);
        ...
        public Common.ClientResult.Result Put([FromBody]EmployeeContact entity)
        {
            ...
            {   //数据校验
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.UpdateSucceed + "，员工联系方式信息的Id为" + entity.Id,"员工联系方式"
                        );//写入日志                   
                    result.Code = Common.ClientCode.Succeed;
                ...
                else
                {
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，员工联系方式信息的Id为" + entity.Id + "," + returnValue, "员工联系方式"
                        );//写入日志   
                    result.Code = Common.ClientCode.Fail;
        ...
        IBLL.IEmployeeContactBLL m_BLL;

        ValidationErrors validationErrors = new ValidationErrors();

        public EmployeeContactApiController()
            : this(new EmployeeContactBLL()) { }
