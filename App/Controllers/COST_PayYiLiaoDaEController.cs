...
namespace Langben.App.Controllers
{
    ...
    /// 费用_社保支出大病
    /// </summary>
    public class COST_PayYiLiaoDaEController : BaseController
    {
        ...
        public JsonResult GetData(int? id, int page, int rows, string order, string sort, string search)
        {
            ...
            int total = 0;
            List<COST_PayYiLiaoDaE> queryData = m_BLL.GetByParam(id, page, rows, order, sort, search, ref total);
        ...
        public ActionResult Export(string id, string title, string field, string sortName, string sortOrder, string search)
        {
            ...
            List<COST_PayYiLiaoDaE> queryData = m_BLL.GetByParam(id, sortOrder, sortName, search);
        ...
        {
            COST_PayYiLiaoDaE item = m_BLL.GetById(id);
            return View(item);
        ...
        [HttpPost]
        [SupportFilter]
        public ActionResult Edit(int id, COST_PayYiLiaoDaE entity)
        {
            if (entity != null && ModelState.IsValid)
            {   //数据校验
                ...
                {
                    LogClassModels.WriteServiceLog(Suggestion.UpdateSucceed + "，费用_社保支出大病信息的Id为" + id, "费用_社保支出大病"
                        );//写入日志                           
                ...
                { 
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，费用_社保支出大病信息的Id为" + id + "," + returnValue, "费用_社保支出大病"
                        );//写入日志                           
        ...
        IBLL.ICOST_PayYiLiaoDaEBLL m_BLL;

        ValidationErrors validationErrors = new ValidationErrors();

        public COST_PayYiLiaoDaEController()
            : this(new COST_PayYiLiaoDaEBLL()) { }

        public COST_PayYiLiaoDaEController(COST_PayYiLiaoDaEBLL bll)
        {
            m_BLL = bll;
        }
