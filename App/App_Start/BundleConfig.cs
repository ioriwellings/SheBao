    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/ztree").Include(
                    "~/Res/ztree/js/jquery.ztree.core-3.5.js",
                    "~/Res/ztree/js/jquery.ztree.excheck-3.5.js",
                    "~/Res/ztree/js/jquery.ztree.exedit-3.5.js"));
            ...
            bundles.Add(new StyleBundle("~/Content/css").Include(
                      "~/Res/easyui/themes/bootstrap/easyui.css",
                      "~/Res/easyui/themes/icon.css",
                      "~/Content/default.css",
                      "~/Content/StyleSheet.css",
                      "~/Res/ztree/zTreeStyle/zTreeStyle.css"));
        }
    }
}
