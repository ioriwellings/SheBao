...
namespace Langben.App.Areas.CRM.Controllers
{
    ...
    /// 客户_企业联系人信息_待审核
    /// </summary>
    public class CRM_CompanyLinkMan_AuditApiController : BaseApiController
    {
        /// <summary>
        /// 根据ID获取数据模型
        /// </summary>
        ...
        /// <returns></returns>
        public CRM_CompanyLinkMan_Audit Get(int id)
        {
            CRM_CompanyLinkMan_Audit item = m_BLL.GetById(id);
            return item;
        }
        ...
        /// <returns></returns>
        public Common.ClientResult.Result Post([FromBody]CRM_CompanyLinkMan_Audit entity)
        {           
        ...
        public Common.ClientResult.Result ReturnEdit(int ID, int MainTableID)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog("操作成功" + "，客户_企业联系人信息_审核未通过的Id为" + ID, "客户_企业联系人信息_审核修改内容"
                        );//写入日志                   
                    result.Code = Common.ClientCode.Succeed;
                    result.Message = "操作成功";
                ...
                else
                {
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，客户_企业联系人信息_审核未通过的Id为" + ID + "," + returnValue, "客户_企业联系人信息_审核修改内容"
                        );//写入日志   
                    result.Code = Common.ClientCode.Fail;
        ...
        public Common.ClientResult.Result PassEdit(int ID, int MainTableID)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    LogClassModels.WriteServiceLog("操作成功" + "，客户_企业联系人信息_审核通过的Id为" + ID, "客户_企业联系人信息_审核修改内容"
                        );//写入日志                   
                    result.Code = Common.ClientCode.Succeed;
                    result.Message = "操作成功";
                    return result; //提示更新成功 
                ...
                else
                {
                    ...
                    LogClassModels.WriteServiceLog(Suggestion.UpdateFail + "，客户_企业联系人信息_审核通过的Id为" + ID + "," + returnValue, "客户_企业联系人信息_审核修改内容"
                        );//写入日志   
                    result.Code = Common.ClientCode.Fail;
                    result.Message = "操作成功" + returnValue;
                    return result; //提示更新失败
        ...
        #endregion
        IBLL.ICRM_CompanyLinkMan_AuditBLL m_BLL;

        ValidationErrors validationErrors = new ValidationErrors();

        public CRM_CompanyLinkMan_AuditApiController()
            : this(new CRM_CompanyLinkMan_AuditBLL()) { }

        public CRM_CompanyLinkMan_AuditApiController(CRM_CompanyLinkMan_AuditBLL bll)
        {
            m_BLL = bll;
        }
