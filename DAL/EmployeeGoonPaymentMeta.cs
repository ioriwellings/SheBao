...
{
    [MetadataType(typeof(EmployeeGoonPaymentMetadata))]//使用EmployeeGoonPaymentMetadata对EmployeeGoonPayment进行数据验证
    ...
    public partial class EmployeeGoonPaymentMetadata
    {
