...
{
    [MetadataType(typeof(COST_PayGongShangMetadata))]//使用COST_PayGongShangMetadata对COST_PayGongShang进行数据验证
    public partial class COST_PayGongShang 
    {
    ...
    public partial class COST_PayGongShangMetadata
    {
