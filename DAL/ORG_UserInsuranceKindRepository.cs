...
namespace Langben.DAL
{
    ...
    /// 客服社保种类
    /// </summary>
    public partial class ORG_UserInsuranceKindRepository : BaseRepository<ORG_UserInsuranceKind>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<ORG_UserInsuranceKind> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<ORG_UserInsuranceKind>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条客服社保种类的主键</param>
        public void Delete(SysEntities db, int id)
        {
            ORG_UserInsuranceKind deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.ORG_UserInsuranceKind.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<ORG_UserInsuranceKind> collection = from f in db.ORG_UserInsuranceKind
