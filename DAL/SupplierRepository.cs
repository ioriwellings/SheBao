...
namespace Langben.DAL
{
    ...
    public partial class SupplierRepository : BaseRepository<Supplier>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<Supplier> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<Supplier>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取供应商信息---查看详细，首次编辑
        /// </summary>
        ...
        /// <param name="id">主键</param>
        /// <returns>供应商信息</returns>
        public Supplier GetById(SysEntities db, int id)
        { 
        ...
        /// <param name="id">一条供应商信息的主键</param>
        public void Delete(SysEntities db, int id)
        {
            Supplier deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.Supplier.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<Supplier> collection = from f in db.Supplier
