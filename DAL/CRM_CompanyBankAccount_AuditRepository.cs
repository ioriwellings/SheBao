...
namespace Langben.DAL
{
    ...
    /// 客户_企业银行账户_待审核
    /// </summary>
    public partial class CRM_CompanyBankAccount_AuditRepository : BaseRepository<CRM_CompanyBankAccount_Audit>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<CRM_CompanyBankAccount_Audit> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<CRM_CompanyBankAccount_Audit>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条客户_企业银行账户_待审核的主键</param>
        public void Delete(SysEntities db, int id)
        {
            CRM_CompanyBankAccount_Audit deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.CRM_CompanyBankAccount_Audit.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<CRM_CompanyBankAccount_Audit> collection = from f in db.CRM_CompanyBankAccount_Audit
