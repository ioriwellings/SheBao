...
namespace Langben.DAL
{
    ...
    /// 费用_费用表
    /// </summary>
    public partial class COST_CostTableRepository : BaseRepository<COST_CostTable>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<COST_CostTable> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<COST_CostTable>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">主键</param>
        /// <returns>费用_费用表</returns>
        public COST_CostTable GetById(SysEntities db, int id)
        { 
            return db.COST_CostTable.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条费用_费用表的主键</param>
        public void Delete(SysEntities db, int id)
        {
            COST_CostTable deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.COST_CostTable.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
