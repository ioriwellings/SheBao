...
{
    [MetadataType(typeof(EmployeeStopPaymentMetadata))]//使用EmployeeStopPaymentMetadata对EmployeeStopPayment进行数据验证
    ...
    public partial class EmployeeStopPaymentMetadata
    {
