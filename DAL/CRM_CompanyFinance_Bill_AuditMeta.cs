...
{
    [MetadataType(typeof(CRM_CompanyFinance_Bill_AuditMetadata))]//使用CRM_CompanyFinance_Bill_AuditMetadata对CRM_CompanyFinance_Bill_Audit进行数据验证
    public partial class CRM_CompanyFinance_Bill_Audit
    {
    ...
    public partial class CRM_CompanyFinance_Bill_AuditMetadata
    {
        ...
        [ScaffoldColumn(true)]
        [Display(Name = "企业财务信息（开票）", Order = 2)]
        [Range(0, 2147483646, ErrorMessage = "数值超出范围")]
        public int? CRM_CompanyFinance_Bill_ID { get; set; }
        ...
        [Display(Name = "开票名称", Order = 5)]
        [StringLength(200, ErrorMessage = "长度不可超过200")]
        public object BillName { get; set; }

        [ScaffoldColumn(true)]
        [Required(ErrorMessage = "请填写{0}")]
        [Display(Name = "税务登记证号", Order = 6)]
