...
namespace Langben.DAL
{
    ...
    public partial class LadderLowestPriceRepository : BaseRepository<LadderLowestPrice>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<LadderLowestPrice> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext
                     .CreateObjectSet<LadderLowestPrice>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取客户_企业报价---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>客户_企业报价</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>客户_企业报价</returns>
        public LadderLowestPrice GetById(SysEntities db, string id)
        {
            return db.LadderLowestPrice.SingleOrDefault(s => s.Id == id);
        ...
        /// <param name="id">一条客户_企业报价的主键</param>
        public void Delete(SysEntities db, string id)
        {
            LadderLowestPrice deleteItem = GetById(db, id);
            if (deleteItem != null)
            {
                db.LadderLowestPrice.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<LadderLowestPrice> collection = from f in db.LadderLowestPrice
