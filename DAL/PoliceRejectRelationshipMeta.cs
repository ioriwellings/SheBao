...
{
    [MetadataType(typeof(PoliceRejectRelationshipMetadata))]//使用PoliceRejectRelationshipMetadata对PoliceRejectRelationship进行数据验证
    public partial class PoliceRejectRelationship 
    {
    ...
    public partial class PoliceRejectRelationshipMetadata
    {
