...
namespace Langben.DAL
{
    ...
    public partial class CRM_CompanyToBranchRepository : BaseRepository<CRM_CompanyToBranch>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<CRM_CompanyToBranch> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<CRM_CompanyToBranch>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取客户_企业归属机构---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>客户_企业归属机构</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>客户_企业归属机构</returns>
        public CRM_CompanyToBranch GetById(SysEntities db, int id)
        { 
            return db.CRM_CompanyToBranch.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条客户_企业归属机构的主键</param>
        public void Delete(SysEntities db, int id)
        {
            CRM_CompanyToBranch deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.CRM_CompanyToBranch.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<CRM_CompanyToBranch> collection = from f in db.CRM_CompanyToBranch
