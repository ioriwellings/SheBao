...
{
    [MetadataType(typeof(COST_PayShiYeMetadata))]//使用COST_PayShiYeMetadata对COST_PayShiYe进行数据验证
    public partial class COST_PayShiYe 
    {
    ...
    public partial class COST_PayShiYeMetadata
    {
