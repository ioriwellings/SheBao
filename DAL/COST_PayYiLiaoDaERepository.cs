...
namespace Langben.DAL
{
    ...
    /// 费用_社保支出医疗大额
    /// </summary>
    public partial class COST_PayYiLiaoDaERepository : BaseRepository<COST_PayYiLiaoDaE>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<COST_PayYiLiaoDaE> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<COST_PayYiLiaoDaE>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条费用_社保支出医疗大额的主键</param>
        public void Delete(SysEntities db, int id)
        {
            COST_PayYiLiaoDaE deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.COST_PayYiLiaoDaE.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<COST_PayYiLiaoDaE> collection = from f in db.COST_PayYiLiaoDaE
