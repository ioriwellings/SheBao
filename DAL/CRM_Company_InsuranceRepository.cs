...
namespace Langben.DAL
{
    ...
    public partial class CRM_Company_InsuranceRepository : BaseRepository<CRM_Company_Insurance>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<CRM_Company_Insurance> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<CRM_Company_Insurance>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取客户_社保信息---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>客户_社保信息</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>客户_社保信息</returns>
        public CRM_Company_Insurance GetById(SysEntities db, int id)
        { 
            return db.CRM_Company_Insurance.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条客户_社保信息的主键</param>
        public void Delete(SysEntities db, int id)
        {
            CRM_Company_Insurance deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.CRM_Company_Insurance.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<CRM_Company_Insurance> collection = from f in db.CRM_Company_Insurance
