...
{
    [MetadataType(typeof(COST_CostTableServiceMetadata))]//使用COST_CostTableServiceMetadata对COST_CostTableService进行数据验证
    ...
    public partial class COST_CostTableServiceMetadata
    {
			...
			[ScaffoldColumn(true)]
			[Display(Name = "服务金额", Order = 5)]
			[DataType(System.ComponentModel.DataAnnotations.DataType.Currency,ErrorMessage="货币格式不正确")]
			public object ServiceCoset { get; set; }
