...
namespace Langben.DAL
{
    ...
    /// 员工补缴
    /// </summary>
    public partial class EmployeeGoonPaymentRepository : BaseRepository<EmployeeGoonPayment>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<EmployeeGoonPayment> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<EmployeeGoonPayment>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条员工补缴的主键</param>
        public void Delete(SysEntities db, int id)
        {
            EmployeeGoonPayment deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.EmployeeGoonPayment.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<EmployeeGoonPayment> collection = from f in db.EmployeeGoonPayment
