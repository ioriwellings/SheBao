...
{
    [MetadataType(typeof(COST_PayYiLiaoDaEMetadata))]//使用COST_PayYiLiaoDaEMetadata对COST_PayYiLiaoDaE进行数据验证
    public partial class COST_PayYiLiaoDaE 
    {
    ...
    public partial class COST_PayYiLiaoDaEMetadata
    {
