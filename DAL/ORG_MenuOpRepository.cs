...
namespace Langben.DAL
{
    ...
    public partial class ORG_MenuOpRepository : BaseRepository<ORG_MenuOp>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<ORG_MenuOp> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<ORG_MenuOp>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取组织机构_菜单功能---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>组织机构_菜单功能</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>组织机构_菜单功能</returns>
        public ORG_MenuOp GetById(SysEntities db, string id)
        { 
            return db.ORG_MenuOp.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条组织机构_菜单功能的主键</param>
        public void Delete(SysEntities db, string id)
        {
            ORG_MenuOp deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.ORG_MenuOp.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<ORG_MenuOp> collection = from f in db.ORG_MenuOp
