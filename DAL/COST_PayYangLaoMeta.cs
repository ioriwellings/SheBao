...
{
    [MetadataType(typeof(COST_PayYangLaoMetadata))]//使用COST_PayYangLaoMetadata对COST_PayYangLao进行数据验证
    public partial class COST_PayYangLao 
    {
    ...
    public partial class COST_PayYangLaoMetadata
    {
