...
namespace Langben.DAL
{
    ...
    /// 客户_企业信息
    /// </summary>
    public partial class CRM_CompanyRepository : BaseRepository<CRM_Company>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<CRM_Company> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<CRM_Company>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">一条客户_企业信息的主键</param>
        public void Delete(SysEntities db, int id)
        {
            CRM_Company deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.CRM_Company.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<CRM_Company> collection = from f in db.CRM_Company
        ...
        /// <param name="db"></param>
        /// <returns></returns>
        public IQueryable<CRM_Company> GetCompanyList(SysEntities db)
        {
            // 获取公司
