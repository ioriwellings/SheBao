...
{
    public partial class ORG_DepartmentRepository : BaseRepository<ORG_Department>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<ORG_Department> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext
                     .CreateObjectSet<ORG_Department>().Where(string.IsNullOrEmpty(where) ? "true" : where)
