...
namespace Langben.DAL
{
    ...
    public partial class EmployeeGoonPayment2Repository : BaseRepository<EmployeeGoonPayment2>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<EmployeeGoonPayment2> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<EmployeeGoonPayment2>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取员工调基---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>员工调基</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>员工调基</returns>
        public EmployeeGoonPayment2 GetById(SysEntities db, int id)
        { 
            return db.EmployeeGoonPayment2.SingleOrDefault(s => s.Id == id);
        ...
        /// <param name="id">一条员工调基的主键</param>
        public void Delete(SysEntities db, int id)
        {
            EmployeeGoonPayment2 deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.EmployeeGoonPayment2.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<EmployeeGoonPayment2> collection = from f in db.EmployeeGoonPayment2
        ...
        /// <summary>
        /// 根据EmployeeAddId，获取所有员工调基数据
        /// </summary>
        /// <param name="id">外键的主键</param>
        /// <returns></returns>
        public IQueryable<EmployeeGoonPayment2> GetByRefEmployeeAddId(SysEntities db, int id)
        {
            return from c in db.EmployeeGoonPayment2
