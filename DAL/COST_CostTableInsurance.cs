...
namespace Langben.DAL
{
    ...
    public partial class COST_CostTableInsurance
    {
        ...
        public Nullable<decimal> CompanyRadix { get; set; }
        public Nullable<decimal> CompanyCost { get; set; }
        public Nullable<double> CompanyRatio { get; set; }
        public Nullable<decimal> PersonRadix { get; set; }
        public Nullable<decimal> PersonCost { get; set; }
        public Nullable<double> PersonRatio { get; set; }
