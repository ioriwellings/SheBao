...
{
    [MetadataType(typeof(EmployeeGoonPaymentHistoryMetadata))]//使用EmployeeGoonPaymentHistoryMetadata对EmployeeGoonPaymentHistory进行数据验证
    public partial class EmployeeGoonPaymentHistory 
    {
    ...
    public partial class EmployeeGoonPaymentHistoryMetadata
    {
			...
			[ScaffoldColumn(true)]
			[Display(Name = "新工资", Order = 3)]
			public object NewWage { get; set; }

			[ScaffoldColumn(true)]
			[Display(Name = "增加员工", Order = 4)]
			[Range(0,2147483646, ErrorMessage="数值超出范围")]
			public int? EmployeeAddId { get; set; }

			[ScaffoldColumn(true)]
			[Display(Name = "是否调基月", Order = 5)]
