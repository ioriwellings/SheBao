...
{
    [MetadataType(typeof(COST_PayGongJiJinBCMetadata))]//使用COST_PayGongJiJinBCMetadata对COST_PayGongJiJinBC进行数据验证
    public partial class COST_PayGongJiJinBC 
    {
    ...
    public partial class COST_PayGongJiJinBCMetadata
    {
