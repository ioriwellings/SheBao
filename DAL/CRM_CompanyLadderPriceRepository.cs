...
namespace Langben.DAL
{
    ...
    public partial class CRM_CompanyLadderPriceRepository : BaseRepository<CRM_CompanyLadderPrice>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<CRM_CompanyLadderPrice> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<CRM_CompanyLadderPrice>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取客户_企业阶梯报价---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>客户_企业阶梯报价</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>客户_企业阶梯报价</returns>
        public CRM_CompanyLadderPrice GetById(SysEntities db, int id)
        { 
            return db.CRM_CompanyLadderPrice.SingleOrDefault(s => s.ID == id);
        ...
        /// <param name="id">一条客户_企业阶梯报价的主键</param>
        public void Delete(SysEntities db, int id)
        {
            CRM_CompanyLadderPrice deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.CRM_CompanyLadderPrice.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<CRM_CompanyLadderPrice> collection = from f in db.CRM_CompanyLadderPrice
