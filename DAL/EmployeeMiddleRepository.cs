...
namespace Langben.DAL
{
    ...
    /// 员工费用中间表
    /// </summary>
    public partial class EmployeeMiddleRepository : BaseRepository<EmployeeMiddle>, IDisposable
    {
        /// <summary>
        /// 查询的数据
        /// </summary>
        ...
        /// <returns></returns>      
        public IQueryable<EmployeeMiddle> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<EmployeeMiddle>().Where(string.IsNullOrEmpty(where) ? "true" : where)
                     .OrderBy("it.[" + sort.GetString() + "] " + order.GetString())
                     .AsQueryable(); 

        }
        /// <summary>
        /// 通过主键id，获取员工费用中间表---查看详细，首次编辑
        /// </summary>
        /// <param name="id">主键</param>
        /// <returns>员工费用中间表</returns>
        ...
        /// <param name="id">主键</param>
        /// <returns>员工费用中间表</returns>
        public EmployeeMiddle GetById(SysEntities db, int id)
        { 
            return db.EmployeeMiddle.SingleOrDefault(s => s.Id == id);
        ...
        /// <param name="id">一条员工费用中间表的主键</param>
        public void Delete(SysEntities db, int id)
        {
            EmployeeMiddle deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.EmployeeMiddle.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
