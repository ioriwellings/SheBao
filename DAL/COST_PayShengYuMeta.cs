...
{
    [MetadataType(typeof(COST_PayShengYuMetadata))]//使用COST_PayShengYuMetadata对COST_PayShengYu进行数据验证
    public partial class COST_PayShengYu 
    {
    ...
    public partial class COST_PayShengYuMetadata
    {
