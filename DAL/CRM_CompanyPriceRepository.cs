...
namespace Langben.DAL
{
    ...
    public partial class CRM_CompanyPriceRepository : BaseRepository<CRM_CompanyPrice>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<CRM_CompanyPrice> GetData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
            ...
            return ((System.Data.Entity.Infrastructure.IObjectContextAdapter)db).ObjectContext 
                     .CreateObjectSet<CRM_CompanyPrice>().Where(string.IsNullOrEmpty(where) ? "true" : where)
        ...
        /// <param name="id">主键</param>
        /// <returns>客户_企业报价</returns>
        public CRM_CompanyPrice GetById(SysEntities db, int id)
        { 
            return db.CRM_CompanyPrice.SingleOrDefault(s => s.ID == id);
        ...
        {
            CRM_CompanyPrice deleteItem = GetById(db, id);
            if (deleteItem != null)
            { 
                db.CRM_CompanyPrice.Remove(deleteItem);
            }
        }
        /// <summary>
        /// 删除对象集合
        ...
        {
            //数据库设置级联关系，自动删除子表的内容   
            IQueryable<CRM_CompanyPrice> collection = from f in db.CRM_CompanyPrice
